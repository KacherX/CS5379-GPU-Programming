...
int main(void) {
  ...
  CUDA_CHECK(cudaMemPrefetchAsync(x, N*N*sizeof(double), device));
  CUDA_CHECK(cudaMemPrefetchAsync(y, N*N*sizeof(double), device));
  CUDA_CHECK(cudaMemPrefetchAsync(ans, N*N*sizeof(double), device));
  ...
  // ..........................................................................
  double avg=0;
  std::cout<<"Starting optimized GPU computation with multiple blocks"<<std::endl;
  // Run kernel on GPU
